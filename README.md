[![Run App Long Nguyen](https://github.com/l0ngewinn/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/l0ngewinn/GithubActions/actions/workflows/run-app.yaml)
